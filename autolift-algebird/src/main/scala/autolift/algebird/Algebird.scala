...
object Algebird extends Syntax with Context with Reexports with Implicits{
	...
	implicit def mkJ[Obj1, Obj2](implicit lift: AlgeLiftJoin[Obj1, Obj2]): AlgeLiftJoin.Aux[Obj1, Obj2, lift.Out] = lift
	implicit def mkJw[Obj1, Obj2, Fn](implicit lift: AlgeLiftJoinWith[Obj1, Obj2, Fn]): AlgeLiftJoinWith.Aux[Obj1, Obj2, Fn, lift.Out] = lift
